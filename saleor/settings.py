...
_DEFAULT_CLIENT_HOSTS = "localhost,127.0.0.1,https://interflexlabs-saleor-admin.herokuapp.com/"
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,127.0.0.1,interflexlabs-saleor-api.herokuapp.com"))
